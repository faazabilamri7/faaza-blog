...
<InteractiveDemo type="codepen" id="abLwYbM" title="CSS Grid Layout Demo" />

### JSFiddle Demo

<InteractiveDemo type="jsfiddle" id="u3k0f6m8" title="JavaScript Animation Demo" />

### CodeSandbox Demo

<InteractiveDemo type="codesandbox" id="react-typescript" title="React TypeScript Demo" />
